...
from app.app_utils.telemetry import setup_telemetry, setup_agent_engine_telemetry
...
if os.getenv("INTEGRATION_TEST") == "TRUE":
    ...
    class MockCloudLogger:
        def log_struct(self, *args, **kwargs):
            std_logging.info(f"MockCloudLogger: log_struct args={args} kwargs={kwargs}")
...
# Attach reasoning engine routes for Agent Runtime / Vertex AI integration
